...
<?php 
 ...
 if(isset($_POST['clik']) && !empty($_POST['login']) && !empty($_POST['mdp']))  {      
    ...
    $tab = [] ;
    $js = file_get_contents('joueur.json') ;
    $objet = json_decode($js , true) ;
        //  $ad = file_get_contents('admin.json') ;
        //               $objet1 = json_decode($ad , true) ;
    ...
    //   var_dump($objet) ;
     for ($i=0; $i < count($objet); $i++) 
          { 
                 ...
                 if( $_SESSION['login']  == $tab[$i]['login'] && $_SESSION['mdp'] == $tab[$i]['mot de passe'])
                 { 
                    ...
                    //  if( $_SESSION['login'] = $_POST['login']  == $objet1[$i]['login'] && $_SESSION['mdp'] == $objet1[$i]['mot de passe']){ 
